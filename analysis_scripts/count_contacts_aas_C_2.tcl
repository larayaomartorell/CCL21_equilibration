...
#  puts $fp "$frame" 
   ...
   set sel1 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname ARG}]
   set sel2 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname HIS}]
   set sel3 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname LYS}]
   set sel4 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname ASP}]
   set sel5 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname GLU}]
   set sel6 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname SER}]
   set sel7 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname THR}]
   set sel8 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname ASN}]
   set sel9 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname GLN}]
   set sel10 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname CYS}]
   set sel12 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname GLY}]
   set sel13 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname PRO}]
   set sel14 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname ALA}] 
   set sel15 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname VAL}]
   set sel16 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname ILE}]
   set sel17 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname LEU}]
   set sel18 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname MET}]
   set sel19 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname PHE}]
   set sel20 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname TYR}]
   set sel21 [atomselect $mol {resname PEG and type CG321 and within 3.5 of resname TRP}]
...
set fp [ open "../data/contacts_aas_C_2.txt" w ] 
